...
Templates engineers copy when setting up Cline. Full walkthrough: `docs/cline-setup.md`.

- `settings.example.md` — the exact values to enter in Cline's provider settings.
